 ...
 * 'server' and another with the namespace 'app', in the LOGGER_NAMESPACES environment variable you can write
 ...
 * want to debug all you can write LOGGER_NAMESPACES = *.
